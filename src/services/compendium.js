...
const SYSTEM_EDITABLE = ['nom', 'quadrant', 'faction', 'is_frontiere', 'route', 'gouvernement', 'texte_ambiance', 'description', 'soleil_json', 'corps_celestes_json', 'patrouilles_json'];
